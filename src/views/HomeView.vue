...
<template>
  <div class="flex flex-col items-center justify-center flex-1 space-y-3 mt-24">
    ...
    <h4 class="text-xl font-bold">Starts at USD 3.99. Cancel anytime.</h4>
    <p class="font-thin">Ready to watch? Enter your email to create or restart your membership.</p>
